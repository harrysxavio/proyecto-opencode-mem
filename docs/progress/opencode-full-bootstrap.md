...
- Tarea activa: [Task 6 — Quality remediation](../superpowers/plans/2026-06-18-opencode-full-bootstrap-implementation.md#task-6-implement-dependency-execution-and-the-verification-registry) (`in_progress`).
...
- Reviews:
  - Self-review: `APPROVED`.
  - Spec: `PENDING`.
  - Quality: `CHANGES_REQUESTED`; remediación transaccional y de inmutabilidad en curso.
